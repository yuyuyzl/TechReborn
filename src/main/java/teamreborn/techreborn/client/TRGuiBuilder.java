 ...
 */
public class TRGuiBuilder extends GuiBuilder
{
    ...
    public void drawMultiEnergyBar(GuiBase gui, int x, int y, int energyStored, int maxEnergyStored, int mouseX, int mouseY, int buttonID, AdvancedGui.Layer layer) {
        if (layer == AdvancedGui.Layer.BACKGROUND) {
            x += gui.getGuiLeft();
            y += gui.getGuiTop();
        }
        if (layer == AdvancedGui.Layer.FOREGROUND) {
...
//        gui.addPowerButton(x, y, buttonID, layer);
    ...
    public void drawProgressBar(GuiBase gui, int progress, int maxProgress, int x, int y, int mouseX, int mouseY, ProgressDirection direction, AdvancedGui.Layer layer) {
        if (layer == AdvancedGui.Layer.BACKGROUND) {
            x += gui.getGuiLeft();
            y += gui.getGuiTop();
        }
    ...
    public void drawTank(GuiBase gui, int x, int y, int mouseX, int mouseY, FluidStack fluid, int maxCapacity, boolean isTankEmpty, AdvancedGui.Layer layer) {
        if (layer == AdvancedGui.Layer.BACKGROUND) {
            x += gui.getGuiLeft();
            y += gui.getGuiTop();
        }
    ...
    public void drawJEIButton(GuiBase gui, int x, int y, AdvancedGui.Layer layer) {
    ...
    public void drawHologramButton(GuiBase gui, int x, int y, int mouseX, int mouseY, AdvancedGui.Layer layer) {
        if (layer == AdvancedGui.Layer.BACKGROUND) {
            x += gui.getGuiLeft();
            y += gui.getGuiTop();
        }
...
//        }
    ...
    public void drawBigBlueBar(AdvancedGui gui, int x, int y, int value, int max, int mouseX, int mouseY, String suffix, AdvancedGui.Layer layer) {
        if (layer == AdvancedGui.Layer.BACKGROUND) {
            x += gui.getGuiLeft();
            y += gui.getGuiTop();
        }
    ...
    public void drawBigHeatBar(AdvancedGui gui, int x, int y, int value, int max, AdvancedGui.Layer layer) {
        if (layer == AdvancedGui.Layer.BACKGROUND) {
            x += gui.getGuiLeft();
            y += gui.getGuiTop();
        }
    ...
    public void drawMultiblockMissingBar(AdvancedGui gui, AdvancedGui.Layer layer) {
        int x = 0;
        int y = 4;
        if (layer == AdvancedGui.Layer.BACKGROUND) {
            x += gui.getGuiLeft();
    ...
    public void drawBigBlueBar(AdvancedGui gui, int x, int y, int value, int max, int mouseX, int mouseY, AdvancedGui.Layer layer) {
    ...
    public void drawBurnBar(GuiBase gui, int progress, int maxProgress, int x, int y, int mouseX, int mouseY, AdvancedGui.Layer layer) {
        if (layer == AdvancedGui.Layer.BACKGROUND) {
            x += gui.getGuiLeft();
            y += gui.getGuiTop();
        }
